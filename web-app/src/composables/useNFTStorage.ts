...
export function useNFTStorage() {
  ...
  // https://bafkreihxwkvm5xgzkzrz34rixlrmzgqtf5xjrbddbq5gnsevfrj7uw4juy.ipfs.nftstorage.link/
  ...
  return { checkExist, storeBlob, client, storeNFTMetadata, storeJson, getInfo, getJson, getStatus }
}
